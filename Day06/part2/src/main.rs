...
/*
This is a naive solution which calculates the number of unique characters at each stage.
A better way to do it would be to use bitwise operations. This would make it O(N^2), rather
than O(N^3), though it could almost certainly be done in O(N).
*/
